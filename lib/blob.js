 ...
 *     read:              false,                  // Read the content, properties, metadata or block list of a blob or
 *                                                // of any blob in the container if the resourceType is a container.
 ...
 *    leaseBreakPeriod: '...',          // For a break operation, proposed duration the lease should continue before
 ...
 *    pageBlobSequenceNumber: 0,                // The sequence number - a user-controlled value that you can use to
 *                                              // track requests (optional, only for page blobs)
 * }
 *```
 ...
 *    pageBlobSequenceNumberAction: 'max|update|increment',   // Indicates how the service should modify the blob's
 *                                                            // sequence number.
 ...
 * ```js
 * {
 *    ifModifiedSince: new Date(),      // Specify this to perform the operation only if the resource has been modified
 *                                      // since the specified time. (optional)
 *    ifUnmodifiedSince: new Date(),    // Specify this to perform the operation only if the resource has not been
 *                                      // modified since the specified date/time. (optional)
 *    ifMatch: '...',                   // ETag value. Specify this to perform the operation only if the resource's
 *                                      // ETag matches the value specified. (optional)
 ...
 *    latestBlockIds: [],               // List of block ids to indicate that the Blob service should first search
 *                                      // the uncommitted block list. If the block is found in the uncommitted list,
 *                                      // that version of the block is the latest and should be written to the blob.
 *                                      // If the block is not found in the uncommitted list, then the service should
 *                                      // search the committed block list for the named block and write that block
 *                                      // to the blob if it is found. (optional)
 * }
 *
 * @result {Promise} - A promise for an object on the form:
 * ```js
