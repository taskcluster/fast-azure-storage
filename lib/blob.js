 ...
 *                                                // Specify 'container' if the shared resource is a 'container'. This grants access to the content and metadata of any
 ...
 *      delete: true|false,       // Indicates whether all delete requests should be logged (required if logging specified)
 *      read: true|false,         // Indicates whether all read requests should be logged (required if logging specified)
 *      write: true|false,        // Indicates whether all write requests should be logged (required if logging specified)
 *      retentionPolicy: {
 *        enabled: true|false,    // Indicates whether a retention policy is enabled for the storage service (required)
 ...
 *      version: '...',           // The version of Storage Analytics to configure (required if hourMetrics specified)
 *      enabled: true|false,      // Indicates whether metrics are enabled for the Blob service (required if hourMetrics specified).
 *      includeAPIs: true|false,  // Indicates whether metrics should generate summary statistics for called API operations (Required only if metrics are enabled).
 *      retentionPolicy: {
 *        enabled: true|false,
 *        days: '...',
 *      },
 ...
 *      version: '...',           // The version of Storage Analytics to configure(required if minuteMetrics specified)
 *      enabled: true|false,      // Indicates whether metrics are enabled for the Blob service (required if minuteMetrics specified).
 *      includeAPIs: true|false,  // Indicates whether metrics should generate summary statistics for called API operations (Required only if metrics are enabled).
 *      retentionPolicy: {
 *        enabled: true|false,
 *        days: '...',
 ...
 *      allowedOrigins: [],       // A list of origin domains that will be allowed via CORS, or "*" to allow all domains
 ...
 *      includeAPIs: true|false,  // Indicates whether metrics should generate summary statistics for called API operations.
 *      retentionPolicy: {
 *        enabled: true|false,
 *        days: '...',
 *      },
 ...
 *    publicAccessLevel: '...', // Specifies whether data in the container may be accessed publicly and the level of access.
 ...
 *    type: BlockBlob|PageBlob|AppendBlob,  // The type of blob to create: block blob, page blob, or append blob (required)
