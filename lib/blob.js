...
/**
 * Creates a new block or updates the content of an existing block blob.
 ...
 * ```
 */
Blob.prototype.putBlockBlob = function putBlockBlob(container, blob, options, content){
  options = options || {};
  options.blobType = 'BlockBlob';
  this.putBlob(container, blob, options, content);
};

/**
 * Creates a new page blob.
 *
 * Note that a call to a createPageBlob only initializes the blob.
 * To add content to a page blob, call the putPage.s
 *
 * @method putPageBlob
 * @param {string} container - Name of the container where the blob should be stored
 * @param {string} blob - Name of the blob
 ...
 * ```
 */
Blob.prototype.putPageBlob = function putPageBlob(container, blob, options) {
 options = options || {};
 options.blobType = 'PageBlob';
 this.putBlob(container, blob, options);
};

/**
 * Creates a new append blob.
 *
 * Note that a call to a createAppendBlob only initializes the blob.
 * To add content to an append blob, call the appendBlock.
 *
 * @method putAppendBlob
 * @param {string} container - Name of the container where the blob should be stored
 * @param {string} blob - Name of the blob
 * @param {object} options - Options on the following form
 * ```js
 ...
 * ```
 */
Blob.prototype.putAppendBlob = function putAppendBlob(container, blob, options) {
  options = options || {};
