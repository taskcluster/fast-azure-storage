...
function Table(options) {
  ...
  // Construct hostname
  this.hostname  = options.accountId + '.table.core.windows.net';
 ...
 * @param {string} partitionKey - Partition key of entity to update.
 * @param {string} rowKey - Row key of entity to update.
 * @param {object} options - Options on the following form:
 * ```js
 * {
 *   mode:  'replace' || 'merge'  // Replace entity or merge entity
