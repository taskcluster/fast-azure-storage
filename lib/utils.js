...
var buildRequestOptionsForAuthSharedKey = function buildRequestOptionsForAuthSharedKey(options, method, path, query, headers) {
  ...
  // Compute signature
  var signature = getHmacSha256Sign(options.accessKey, stringToSign);
 ...
 */
var getHmacSha256Sign = function getHmacSha256Sign(accessKey, stringToSign) {
  return crypto
...
exports.getHmacSha256Sign = getHmacSha256Sign;

/**
 * Calculate MD5sum for the content
 */
var getContentMD5 = function getContentMD5(content) {
  var internalHash = crypto.createHash('md5');
  internalHash.update(content, 'utf8');
  return internalHash.digest('base64');
}
